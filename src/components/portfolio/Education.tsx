              ...
              <div className="flex-1">
                <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                  <div>
                    ...
                    <p className="text-primary font-medium mt-0.5">University of Barishal</p>
                  </div>
                  <span
                ...
                <p className="mt-4 text-sm text-foreground/75 leading-relaxed">
                  Focused on plant physiology, botany research, and environmental biology.
                  Conducted fieldwork, laboratory experiments, and statistical analysis as part of
                  undergraduate research projects.
                </p>

                <div className="mt-4 flex flex-wrap gap-2">
                  {["Plant Physiology", "Field Research", "Lab Techniques", "Statistical Analysis"].map((tag) => (
                    <span
                      key={tag}
