        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          ...
          <div>
            <motion.p
              ...
              className="font-display font-semibold text-xl text-foreground mb-8">
                  ...
                  return (
                    <motion.div
                      ...
                      {isOwnerView && count > 1 && (
                        <button
                          onClick={() => remove(i)}
                          className="absolute -top-1 right-2 w-6 h-6 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 hover:scale-110 z-10"
                      ...
                      <div className="flex items-end justify-between mb-2.5">
                        ...
                        <div className="text-sm font-bold ml-3 flex-shrink-0 flex items-center gap-0.5 px-2.5 py-1 rounded-lg"
                      ...
                      <div className="w-full h-2.5 rounded-full overflow-hidden relative"
                        ...
                        <motion.div
                          ...
                          style={{ background: "hsl(var(--card))", border: "2px solid hsl(var(--primary-glow))", boxShadow: "0 0 8px hsl(var(--primary-glow))" }}
                          initial={{ left: 0 }}
                          animate={inView ? { left: `calc(${level}% - 7px)` } : { left: 0 }}
                          transition={{ duration: 1.2, delay: 0.3 + i * 0.1, ease: [0.22, 1, 0.36, 1] }}
                        />
                      </div>
                    </motion.div>
